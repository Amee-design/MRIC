    ...
    $(function () {
        ...
        $("body").delegate(".mfp_window, .wpas_win_link ", "click", function (e) {
            ...
            if ("ajax" === type) {
                ...
                settings.ajax = {};
                settings.ajax.settings = { method: "POST", data: ajax_data };
            }
...
(function ($) {
    "use strict";
    $(".post-detail-description p iframe").wrap('<div class="embed-responsive embed-responsive-16by9"></div>');
    $(".post-detail-description p embed").wrap('<div class="embed-responsive embed-responsive-16by9"></div>');
    $("#pills-review > div:nth-child(1), #pills-review > div:nth-child(2)").remove();
    $("#pills-review #loginform").remove();
    $("#pills-review .edd_download_purchase_form").remove();
    ...
    $(".home-slider").slick({ slidesToShow: 1, autoplay: true, autoplaySpeed: 2000, arrows: false });
    $(".testimonial-slider").slick({
        ...
        arrows: false,
        responsive: [
            { breakpoint: 992, settings: { arrows: false, centerMode: true, centerPadding: "40px", slidesToShow: 1 } },
